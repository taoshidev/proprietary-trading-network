...
11. There is a fee for leaving positions open "carry fee". The fee is equal to 10.95/5.25/3% per year for a 1x leverage position (crypto/indices/forex) <a href="https://docs-git-feat-p7-taoshi.vercel.app/tips/p4/">More info</a>

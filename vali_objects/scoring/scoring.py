...
class Scoring:
    ...
    def compute_results_checkpoint(
        ...
        filtered_positions = PositionUtils.filter(
            full_positions,
            evaluation_time_ms=evaluation_time_ms
        )

        filtered_recent_positions = PositionUtils.filter_recent(
            full_positions,
            evaluation_time_ms=evaluation_time_ms
        )
    ...
    def miner_penalties(
        ...
        for miner, ledger in ledger_dict.items():
            ...
            positional_return_time_consistency = PositionUtils.time_consistency_penalty(positions)
            positional_consistency = PositionUtils.returns_ratio_penalty(positions)

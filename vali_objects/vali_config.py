...
class ValiConfig:
    ...
    SCORING_CALMAR_WEIGHT = 0.3
    SCORING_RETURN_WEIGHT = 0.0
    SCORING_PNL_WEIGHT = 0.7
    ...
    MAINCOMP_MIN_WEIGHT = 3.6e-05
    # increment the CHALLENGE_PERIOD_MINIMUM_DAYS every 14 days by 7, until the value of 120 is reached
    CHALLENGE_PERIOD_MINIMUM_DAYS = InterpolatedValueFromDate("2025-06-06", low=60, increment=7, interval=14, target=45)

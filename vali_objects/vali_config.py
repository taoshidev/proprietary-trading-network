...
class ValiConfig:
    ...
    PLAGIARISM_LOOKBACK_RANGE_MS = 14 * 24 * 60 * 60 * 1000  # 14 days
    ...
    PLAGIARISM_FOLLOW_SIMILARITY_RATIO_THRESHOLD = 1.005 # Threshold for follow percentage plagiarist->victim / victim->plagiarist
    PLAGIARISM_MINIMUM_REVERSE_FOLLOW = 0.01 # Minimum reverse follow for follow percentage ratio to avoid division by 0

...
class ValiConfig:
    ...
    ABNORMALITY_SIGMOID_SHIFT = 1.75
    ...
    # Scoring weights
    SCORING_LONG_RETURN_LOOKBACK_WEIGHT = 0.25
    SCORING_SHORT_RETURN_LOOKBACK_WEIGHT = 0.125
    SCORING_SHARPE_WEIGHT = 0.125
    SCORING_OMEGA_WEIGHT = 0.125
    SCORING_SORTINO_WEIGHT = 0.125
    SCORING_STATISTICAL_CONFIDENCE_WEIGHT = 0.25

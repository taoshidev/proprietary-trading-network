...
class ValiConfig:
    ...
    # Scoring weights
    SCORING_LONG_RETURN_LOOKBACK_WEIGHT = 1.0
    SCORING_SHORT_RETURN_LOOKBACK_WEIGHT = 0.3
    SCORING_SHARPE_WEIGHT = 0.9
    SCORING_OMEGA_WEIGHT = 0.9
    SCORING_SORTINO_WEIGHT = 0.9
    SCORING_STATISTICAL_CONFIDENCE_WEIGHT = 0.5
    SCORING_CONCENTRATION_WEIGHT = 0.5

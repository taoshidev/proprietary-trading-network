...
class ValiConfig:
    ...
    # Martingale Penalty
    MARTINGALE_THRESHOLD = 2.75
    MARTINGALE_CONCENTRATION = 25
    MARTINGALE_SHIFT = 0.1
    MARTINGALE_SPREAD = 50
    MARTINGALE_STEP_THRESHOLD = 1

    MARTINGALE_TIME_WINDOW_MS = 1000 * 60 * 60 * 24 # Positions within a 24-hour window of each other are considered
    INTERPOSITIONAL_MARTINGALE_SHIFT = 0.1
    INTERPOSITIONAL_MARTINGALE_SPREAD = 50

...
class LedgerUtils:
    ...
    @staticmethod
    def drawdown_percentage(drawdown_value: float) -> float:
        """
        Args:
            drawdown_value: float - the drawdown value
    ...
    def mdd_augmentation(recent_drawdown: float) -> float:
        ...
        recent_drawdown_percentage = LedgerUtils.drawdown_percentage(recent_drawdown)

...
class TestEliminationManager(TestBase):
    def setUp(self):
        ...
        self.LEDGERS = {}
        self.LEDGERS[self.MDD_MINER] = generate_losing_ledger(0, ValiConfig.CHALLENGE_PERIOD_MS.value())
        self.LEDGERS[self.REGULAR_MINER] = generate_winning_ledger(0, ValiConfig.CHALLENGE_PERIOD_MS.value())

...
class Validator:
    def __init__(self):
        ...
        self.weight_setter = SubtensorWeightSetter(self.config, self.wallet, self.metagraph, perf_manager=self.perf_ledger_manager)
        self.challengeperiod_manager = ChallengePeriodManager(self.config, self.metagraph, perf_manager=self.perf_ledger_manager)

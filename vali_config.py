...
meta_version = meta_dict.get("version", "x.x.x")
...
class ValiConfig:
    ...
    # Time Configurations
    TARGET_CHECKPOINT_DURATION_MS = 1000 * 60 * 60 * 24  # 6 hours
    ...
    DAILY_CONSISTENCY = 1000 * 60 * 60 * 24  # 1 day
    DAILY_CHECKPOINTS = DAILY_CONSISTENCY // TARGET_CHECKPOINT_DURATION_MS
    DAILY_SIGMOID_SHIFT = 0.35
    DAILY_SIGMOID_SPREAD = 35

    BIWEEKLY_CONSISTENCY = 1000 * 60 * 60 * 24 * 14  # two weeks
    BIWEEKLY_CHECKPOINTS = BIWEEKLY_CONSISTENCY // TARGET_CHECKPOINT_DURATION_MS
    ...
    CHALLENGE_PERIOD_MS = 45 * 24 * 60 * 60 * 1000  # 45 days
    CHALLENGE_PERIOD_RETURN = 1.025

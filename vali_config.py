...
class ValiConfig:
    ...
    PLAGIARISM_MATCHING_TIME_RESOLUTION_MS = 1 * 60 * 1000  # 5 minutes
    PLAGIARISM_THRESHOLD = 0.9
    PLAGIARISM_MAX_LAGS = 60
    PLAGIARISM_LOOKBACK_RANGE_MS = 5 * 24 * 60 * 60 * 1000  # 5 days
    PLAGIARISM_FOLLOWER_TIMELAG_THRESHOLD = 1.005 #change back to value: 1.005
    PLAGIARISM_FOLLOWER_SIMILARITY_THRESHOLD = 0.5 #change back to percentage less than 1
    PLAGIARISM_REPORTING_THRESHOLD = 0.8
    PLAGIARISM_REFRESH_TIME_MS = 1000 * 60 * 5 # Every 5 minutes

...
class TradePair(Enum):
    ...
    # forex
    AUDCAD = ["AUDCAD", "AUD/CAD", 0.00007, 0.01, 500, TradePairCategory.FOREX]
    AUDUSD = ["AUDUSD", "AUD/USD", 0.00007, 0.01, 500, TradePairCategory.FOREX]
    AUDJPY = ["AUDJPY", "AUD/JPY", 0.00007, 0.01, 500, TradePairCategory.FOREX]
    CADCHF = ["CADCHF", "CAD/CHF", 0.00007, 0.01, 500, TradePairCategory.FOREX]
    CADJPY = ["CADJPY", "CAD/JPY", 0.00007, 0.01, 500, TradePairCategory.FOREX]
    CHFJPY = ["CHFJPY", "CHF/JPY", 0.00007, 0.01, 500, TradePairCategory.FOREX]
    EURCAD = ["EURCAD", "EUR/CAD", 0.00007, 0.01, 500, TradePairCategory.FOREX]
    EURUSD = ["EURUSD", "EUR/USD", 0.00007, 0.01, 500, TradePairCategory.FOREX]
    EURCHF = ["EURCHF", "EUR/CHF", 0.00007, 0.01, 500, TradePairCategory.FOREX]
    EURGBP = ["EURGBP", "EUR/GBP", 0.00007, 0.01, 500, TradePairCategory.FOREX]
    EURJPY = ["EURJPY", "EUR/JPY", 0.00007, 0.01, 500, TradePairCategory.FOREX]
    EURNZD = ["EURNZD", "EUR/NZD", 0.00007, 0.01, 500, TradePairCategory.FOREX]
    NZDCAD = ["NZDCAD", "NZD/CAD", 0.00007, 0.01, 500, TradePairCategory.FOREX]
    NZDJPY = ["NZDJPY", "NZD/JPY", 0.00007, 0.01, 500, TradePairCategory.FOREX]
    GBPUSD = ["GBPUSD", "GBP/USD", 0.00007, 0.01, 500, TradePairCategory.FOREX]
    GBPJPY = ["GBPJPY", "GBP/JPY", 0.00007, 0.01, 500, TradePairCategory.FOREX]
    USDCAD = ["USDCAD", "USD/CAD", 0.00007, 0.01, 500, TradePairCategory.FOREX]
    USDCHF = ["USDCHF", "USD/CHF", 0.00007, 0.01, 500, TradePairCategory.FOREX]
    USDJPY = ["USDJPY", "USD/JPY", 0.00007, 0.01, 500, TradePairCategory.FOREX]

...
class ValiConfig:
    ...
    SET_WEIGHT_MINER_CHECKPOINT_CONSISTENCY_DISPLACEMENT = 11.5
    SET_WEIGHT_CHECKPOINT_CONSISTENCY_TAPER = 0.1
    ...
    SCORING_RETURN_CPS_LONG_WEIGHT = 0.50
    ...
    DRAWDOWN_MINVALUE_PERCENTAGE = 0.25
    ...
    SET_WEIGHT_MINER_CHALLENGE_PERIOD_SORTINO_CPS = -1.5e-8
    SET_WEIGHT_MINER_CHALLENGE_PERIOD_OMEGA_CPS = 1.0015
    SET_WEIGHT_MINER_CHALLENGE_PERIOD_RETURN_CPS_PERCENT = 1.0325

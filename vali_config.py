...
class ValiConfig:
    ...
    PLAGIARISM_MATCHING_TIME_RESOLUTION_MS = 60 * 1000  # 1 minute
    ...
    PLAGIARISM_FOLLOWER_SIMILARITY_THRESHOLD = 0.5
    PLAGIARISM_REPORTING_THRESHOLD = 0.8
    PLAGIARISM_REFRESH_TIME_MS = 1000 * 60 * 5 # Every 5 minutes, change to much longer
